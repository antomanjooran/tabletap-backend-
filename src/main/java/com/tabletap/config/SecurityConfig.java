    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,   "/api/menu/categories").hasRole("RESTAURANT")
                        .requestMatchers(HttpMethod.PATCH,  "/api/menu/categories/**").hasRole("RESTAURANT")
                        .requestMatchers(HttpMethod.DELETE, "/api/menu/categories/**").hasRole("RESTAURANT")
                        .requestMatchers(HttpMethod.GET,    "/api/menu/**").permitAll()
